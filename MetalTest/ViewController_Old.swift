...
//
//
//class ViewControllerOld: UIViewController, UIGestureRecognizerDelegate {
...
//    
//    metalView.clearColor = ColorsOld.background
...
//
//
//extension ViewControllerOld: MTKViewDelegate {
